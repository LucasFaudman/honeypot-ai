...
- A total of `503` sessions were logged. `8` sessions were successful logins.
...
- `250` unique source ports were used:  Min: 32872, Max: 60642
...
- A total of `3925` log events were logged in `5` log files: `cowrie.2024-01-10.json`, `cowrie.2024-01-10.log`, `notice.log`, `conn.log`, `ssh.log`
...
- This attack was carried out by a `1` unique **source IP** address(es):
	- `SourceIP 138.197.148.152 Sessions: 503, Successful Logins: 8, Commands: 8, Downloads 8, Zeek Events: 506, `

- `250` unique **source ports** were used:
	- `Src Port: 45139 Used 1 times`
	- `Src Port: 38208 Used 1 times`
	- `Src Port: 57032 Used 1 times`
	- `Src Port: 45526 Used 2 times`
	- `Src Port: 45816 Used 2 times`
	- `Src Port: 53250 Used 2 times`
	- `Src Port: 58904 Used 2 times`
	- `Src Port: 60536 Used 2 times`
	- `Src Port: 33280 Used 2 times`
	- `Src Port: 35600 Used 4 times`
	- `Src Port: 36160 Used 2 times`
	- `Src Port: 37594 Used 2 times`
	- `Src Port: 39134 Used 2 times`
	- `Src Port: 43316 Used 2 times`
	- `Src Port: 44350 Used 2 times`
	- `Src Port: 49780 Used 2 times`
	- `Src Port: 50512 Used 2 times`
	- `Src Port: 51110 Used 2 times`
	- `Src Port: 51830 Used 2 times`
	- `Src Port: 53926 Used 2 times`
	- `Src Port: 55612 Used 2 times`
	- `Src Port: 59256 Used 2 times`
	- `Src Port: 60350 Used 2 times`
	- `Src Port: 37694 Used 2 times`
	- `Src Port: 38444 Used 2 times`
	- `Src Port: 38600 Used 2 times`
	- `Src Port: 39256 Used 2 times`
	- `Src Port: 42212 Used 2 times`
	- `Src Port: 42916 Used 2 times`
	- `Src Port: 47322 Used 2 times`
	- `Src Port: 47706 Used 2 times`
	- `Src Port: 53958 Used 2 times`
	- `Src Port: 54380 Used 2 times`
	- `Src Port: 54626 Used 2 times`
	- `Src Port: 55054 Used 2 times`
	- `Src Port: 58292 Used 2 times`
	- `Src Port: 58742 Used 2 times`
	- `Src Port: 35088 Used 2 times`
	- `Src Port: 35446 Used 2 times`
	- `Src Port: 41690 Used 2 times`
	- `Src Port: 42122 Used 2 times`
	- `Src Port: 42370 Used 2 times`
	- `Src Port: 42848 Used 2 times`
	- `Src Port: 45984 Used 2 times`
	- `Src Port: 46590 Used 2 times`
	- `Src Port: 51036 Used 2 times`
	- `Src Port: 51522 Used 2 times`
	- `Src Port: 57652 Used 2 times`
	- `Src Port: 58216 Used 2 times`
	- `Src Port: 58306 Used 2 times`
	- `Src Port: 58910 Used 2 times`
	- `Src Port: 33846 Used 2 times`
	- `Src Port: 34278 Used 2 times`
	- `Src Port: 38910 Used 2 times`
	- `Src Port: 39162 Used 2 times`
	- `Src Port: 45478 Used 2 times`
	- `Src Port: 45880 Used 2 times`
	- `Src Port: 46188 Used 2 times`
	- `Src Port: 46576 Used 2 times`
	- `Src Port: 49840 Used 2 times`
	- `Src Port: 50296 Used 2 times`
	- `Src Port: 54682 Used 2 times`
	- `Src Port: 55448 Used 2 times`
	- `Src Port: 33116 Used 2 times`
	- `Src Port: 33818 Used 2 times`
	- `Src Port: 33850 Used 2 times`
	- `Src Port: 34560 Used 2 times`
	- `Src Port: 37472 Used 2 times`
	- `Src Port: 38230 Used 2 times`
	- `Src Port: 42460 Used 2 times`
	- `Src Port: 43258 Used 2 times`
	- `Src Port: 49084 Used 2 times`
	- `Src Port: 49760 Used 2 times`
	- `Src Port: 49910 Used 2 times`
	- `Src Port: 50598 Used 4 times`
	- `Src Port: 53388 Used 2 times`
	- `Src Port: 54328 Used 2 times`
	- `Src Port: 58422 Used 2 times`
	- `Src Port: 59236 Used 2 times`
	- `Src Port: 36804 Used 2 times`
	- `Src Port: 37516 Used 2 times`
	- `Src Port: 37644 Used 2 times`
	- `Src Port: 38336 Used 2 times`
	- `Src Port: 41202 Used 2 times`
	- `Src Port: 42002 Used 2 times`
	- `Src Port: 46102 Used 2 times`
	- `Src Port: 47060 Used 2 times`
	- `Src Port: 52692 Used 2 times`
	- `Src Port: 53370 Used 2 times`
	- `Src Port: 53758 Used 2 times`
	- `Src Port: 54430 Used 2 times`
	- `Src Port: 57066 Used 2 times`
	- `Src Port: 58032 Used 2 times`
	- `Src Port: 33740 Used 2 times`
	- `Src Port: 34854 Used 2 times`
	- `Src Port: 40406 Used 2 times`
	- `Src Port: 41102 Used 2 times`
	- `Src Port: 41476 Used 2 times`
	- `Src Port: 42176 Used 2 times`
	- `Src Port: 44760 Used 2 times`
	- `Src Port: 45858 Used 2 times`
	- `Src Port: 49686 Used 2 times`
	- `Src Port: 50884 Used 2 times`
	- `Src Port: 56206 Used 2 times`
	- `Src Port: 56902 Used 2 times`
	- `Src Port: 57594 Used 2 times`
	- `Src Port: 58294 Used 2 times`
	- `Src Port: 60596 Used 2 times`
	- `Src Port: 33744 Used 2 times`
	- `Src Port: 37164 Used 2 times`
	- `Src Port: 38838 Used 2 times`
	- `Src Port: 43732 Used 2 times`
	- `Src Port: 44398 Used 2 times`
	- `Src Port: 45562 Used 2 times`
	- `Src Port: 46236 Used 2 times`
	- `Src Port: 48086 Used 2 times`
	- `Src Port: 49942 Used 2 times`
	- `Src Port: 52892 Used 2 times`
	- `Src Port: 55018 Used 2 times`
	- `Src Port: 59552 Used 2 times`
	- `Src Port: 60240 Used 2 times`
	- `Src Port: 33480 Used 2 times`
	- `Src Port: 34184 Used 2 times`
	- `Src Port: 37898 Used 2 times`
	- `Src Port: 41642 Used 2 times`
	- `Src Port: 41766 Used 2 times`
	- `Src Port: 47932 Used 2 times`
	- `Src Port: 48638 Used 2 times`
	- `Src Port: 48806 Used 2 times`
	- `Src Port: 49622 Used 2 times`
	- `Src Port: 52188 Used 2 times`
	- `Src Port: 53330 Used 2 times`
	- `Src Port: 56400 Used 2 times`
	- `Src Port: 58884 Used 2 times`
	- `Src Port: 34988 Used 2 times`
	- `Src Port: 35674 Used 2 times`
	- `Src Port: 37092 Used 2 times`
	- `Src Port: 37836 Used 2 times`
	- `Src Port: 39376 Used 2 times`
	- `Src Port: 41586 Used 2 times`
	- `Src Port: 45018 Used 2 times`
	- `Src Port: 45794 Used 2 times`
	- `Src Port: 51674 Used 2 times`
	- `Src Port: 52354 Used 2 times`
	- `Src Port: 52434 Used 2 times`
	- `Src Port: 53176 Used 2 times`
	- `Src Port: 56024 Used 2 times`
	- `Src Port: 56772 Used 2 times`
	- `Src Port: 32964 Used 2 times`
	- `Src Port: 33288 Used 2 times`
	- `Src Port: 39662 Used 2 times`
	- `Src Port: 39860 Used 2 times`
	- `Src Port: 40346 Used 2 times`
	- `Src Port: 40556 Used 2 times`
	- `Src Port: 44124 Used 2 times`
	- `Src Port: 44136 Used 2 times`
	- `Src Port: 48832 Used 2 times`
	- `Src Port: 49358 Used 2 times`
	- `Src Port: 55400 Used 2 times`
	- `Src Port: 56060 Used 2 times`
	- `Src Port: 56142 Used 2 times`
	- `Src Port: 56770 Used 2 times`
	- `Src Port: 59734 Used 2 times`
	- `Src Port: 60458 Used 2 times`
	- `Src Port: 36278 Used 2 times`
	- `Src Port: 37326 Used 2 times`
	- `Src Port: 42976 Used 2 times`
	- `Src Port: 43686 Used 2 times`
	- `Src Port: 43922 Used 2 times`
	- `Src Port: 44616 Used 2 times`
	- `Src Port: 47352 Used 2 times`
	- `Src Port: 48318 Used 2 times`
	- `Src Port: 52316 Used 2 times`
	- `Src Port: 53266 Used 4 times`
	- `Src Port: 58888 Used 2 times`
	- `Src Port: 59568 Used 2 times`
	- `Src Port: 59966 Used 2 times`
	- `Src Port: 60642 Used 2 times`
	- `Src Port: 35016 Used 2 times`
	- `Src Port: 36094 Used 2 times`
	- `Src Port: 39624 Used 2 times`
	- `Src Port: 41502 Used 2 times`
	- `Src Port: 46258 Used 2 times`
	- `Src Port: 46920 Used 2 times`
	- `Src Port: 48148 Used 2 times`
	- `Src Port: 48838 Used 2 times`
	- `Src Port: 52468 Used 2 times`
	- `Src Port: 55522 Used 2 times`
	- `Src Port: 57538 Used 2 times`
	- `Src Port: 33888 Used 2 times`
	- `Src Port: 34552 Used 2 times`
	- `Src Port: 35952 Used 2 times`
	- `Src Port: 36652 Used 2 times`
	- `Src Port: 38262 Used 2 times`
	- `Src Port: 40330 Used 2 times`
	- `Src Port: 43026 Used 2 times`
	- `Src Port: 45510 Used 2 times`
	- `Src Port: 49684 Used 2 times`
	- `Src Port: 50372 Used 2 times`
	- `Src Port: 52140 Used 2 times`
	- `Src Port: 52828 Used 2 times`
	- `Src Port: 53982 Used 2 times`
	- `Src Port: 56578 Used 2 times`
	- `Src Port: 59066 Used 2 times`
	- `Src Port: 33204 Used 2 times`
	- `Src Port: 37476 Used 2 times`
	- `Src Port: 38162 Used 2 times`
	- `Src Port: 39846 Used 2 times`
	- `Src Port: 40550 Used 2 times`
	- `Src Port: 41782 Used 2 times`
	- `Src Port: 44258 Used 2 times`
	- `Src Port: 46724 Used 2 times`
	- `Src Port: 49300 Used 2 times`
	- `Src Port: 53940 Used 2 times`
	- `Src Port: 56002 Used 2 times`
	- `Src Port: 56694 Used 2 times`
	- `Src Port: 57548 Used 2 times`
	- `Src Port: 60346 Used 2 times`
	- `Src Port: 34130 Used 2 times`
	- `Src Port: 37310 Used 2 times`
	- `Src Port: 40718 Used 2 times`
	- `Src Port: 41396 Used 2 times`
	- `Src Port: 44134 Used 2 times`
	- `Src Port: 44854 Used 2 times`
	- `Src Port: 44936 Used 2 times`
	- `Src Port: 48558 Used 2 times`
	- `Src Port: 49674 Used 2 times`
	- `Src Port: 53722 Used 2 times`
	- `Src Port: 56290 Used 2 times`
	- `Src Port: 56980 Used 2 times`
	- `Src Port: 60424 Used 2 times`
	- `Src Port: 60628 Used 2 times`
	- `Src Port: 32872 Used 2 times`
	- `Src Port: 36472 Used 2 times`
	- `Src Port: 37304 Used 2 times`
	- `Src Port: 41790 Used 2 times`
	- `Src Port: 43820 Used 2 times`
	- `Src Port: 44514 Used 2 times`
	- `Src Port: 48204 Used 2 times`
	- `Src Port: 48424 Used 2 times`
	- `Src Port: 49114 Used 2 times`
	- `Src Port: 52768 Used 2 times`
	- `Src Port: 53084 Used 2 times`
	- `Src Port: 57860 Used 2 times`
	- `Src Port: 59696 Used 2 times`
	- `Src Port: 60376 Used 2 times`
	- `Src Port: 35818 Used 2 times`
	- `Src Port: 36272 Used 2 times`
	- `Src Port: 36942 Used 2 times`
	- `Src Port: 40656 Used 2 times`

- `1` unique **destination ports** were targeted:
	- `Dst Port: `2222` Used `503` times`

- A total of `503` sessions were logged:
	- `Session CvlFuj3X4Ye2IW9WWk CONN 138.197.148.152:45139 -> 172.31.5.68:2222 Duration: 0.00s`
	- `Session CXI3Y8tysfuENq3P CONN 138.197.148.152:38208 -> 172.31.5.68:2222 Duration: 0.00s`
	- `Session CO6fnE1L05YWGzYiYa CONN 138.197.148.152:57032 -> 172.31.5.68:2222 Duration: 0.00s`
	- `Session Clg6iKbTVFPTrnbOk CONN 138.197.148.152:45526 -> 172.31.5.68:2222 Duration: 0.00s`
	- `Session CLUbPRu9wS77uIgn4 CONN 138.197.148.152:45816 -> 172.31.5.68:2222 Duration: 0.00s`
	- `Session CEC5xfsDDfblPzL5g SSH 138.197.148.152:53250 -> 172.31.5.68:2222 Duration: 0.00s`
	- `Session CUhfmu0HXscUtevH7 SSH 138.197.148.152:58904 -> 172.31.5.68:2222 Duration: 0.00s`
	- `Session C1WXCB2Gj0qgPAXp1d SSH 138.197.148.152:60536 -> 172.31.5.68:2222 Duration: 0.00s`
	- `Session CHtXAz4EqXNkzVJlik SSH 138.197.148.152:33280 -> 172.31.5.68:2222 Duration: 0.00s`
	- `Session ClsFLm3pAJdAWRgPc SSH 138.197.148.152:35600 -> 172.31.5.68:2222 Duration: 0.00s`
	- `Session Cr2ym03P9Y1oPAc5nj SSH 138.197.148.152:36160 -> 172.31.5.68:2222 Duration: 0.00s`
	- `Session CWkOyj4QlB6W0YNxUj SSH 138.197.148.152:37594 -> 172.31.5.68:2222 Duration: 0.00s`
	- `Session C2jztC4piLggJ9PWl5 SSH 138.197.148.152:39134 -> 172.31.5.68:2222 Duration: 0.00s`
	- `Session C1PNGGmrNMP3vfd8 SSH 138.197.148.152:43316 -> 172.31.5.68:2222 Duration: 0.00s`
	- `Session CLuy2lqdiXkAE2euf SSH 138.197.148.152:44350 -> 172.31.5.68:2222 Duration: 0.00s`
	- `(and `488` more)`

- `8` were **successful logins**, 
- `495` were **failed logins**, 
- `8` had commands, 
- `8` had malware.
...
- `0` IP(s) and `1` URL(s) were found in the malware samples
- This attacks was recorded in `3` log types: 
	- `cowrie.log`
	- `cowrie.json`
	- `zeek.log`

- A total of `3925` log events were logged in `5` log files: 
...
| Script | Description |
| --- | --- |
| [setup.py](https://github.com/LucasFaudman/honeypot-ai/blob/main/setup/setup.py) | Setup script for installing the honeypot-ai project |
...
First activity logged: `2024-01-06 08:41:27.953114`
* First session: `CvlFuj3X4Ye2IW9WWk`
* `Session CvlFuj3X4Ye2IW9WWk CONN 138.197.148.152:45139 -> 172.31.5.68:2222 Duration: 0.00s`
...
| --- | --- | --- | --- | --- | --- | --- |
| `CvlFuj3X4Ye2IW9WWk` | `138.197.148.152` | `45139` | `2222` | `2024-01-06 08:41:27.953114` | `2024-01-06 08:41:27.953114` | `0.0` |
...
| --- | --- | --- | --- | --- | --- | --- |
| `CvlFuj3X4Ye2IW9WWk` | `138.197.148.152` | `45139` | `2222` | `2024-01-06 08:41:27.953114` | `2024-01-06 08:41:27.953114` | `0.0` |
| `CXI3Y8tysfuENq3P` | `138.197.148.152` | `38208` | `2222` | `2024-01-07 14:43:37.494442` | `2024-01-07 14:43:37.494442` | `0.0` |
| `CO6fnE1L05YWGzYiYa` | `138.197.148.152` | `57032` | `2222` | `2024-01-09 18:00:12.377446` | `2024-01-09 18:00:12.377446` | `0.0` |
| `Clg6iKbTVFPTrnbOk` | `138.197.148.152` | `45526` | `2222` | `2024-01-09 18:01:37.709069` | `2024-01-09 18:01:37.709069` | `0.0` |
| `CLUbPRu9wS77uIgn4` | `138.197.148.152` | `45816` | `2222` | `2024-01-09 18:01:37.811083` | `2024-01-09 18:01:37.811083` | `0.0` |
| `CEC5xfsDDfblPzL5g` | `138.197.148.152` | `53250` | `2222` | `2024-01-09 18:01:44.543866` | `2024-01-09 18:01:44.543866` | `0.0` |
| `CUhfmu0HXscUtevH7` | `138.197.148.152` | `58904` | `2222` | `2024-01-09 18:01:44.822802` | `2024-01-09 18:01:44.822802` | `0.0` |
| `C1WXCB2Gj0qgPAXp1d` | `138.197.148.152` | `60536` | `2222` | `2024-01-09 18:01:44.915903` | `2024-01-09 18:01:44.915903` | `0.0` |
| `CHtXAz4EqXNkzVJlik` | `138.197.148.152` | `33280` | `2222` | `2024-01-09 18:01:44.962987` | `2024-01-09 18:01:44.962987` | `0.0` |
| `ClsFLm3pAJdAWRgPc` | `138.197.148.152` | `35600` | `2222` | `2024-01-09 18:01:45.103620` | `2024-01-09 18:01:45.103620` | `0.0` |
| `C20ypl3E3Q0RKkJDZ3` | `138.197.148.152` | `52768` | `2222` | `2024-01-09 18:23:18.443279` | `2024-01-09 18:23:18.443279` | `0.0` |
| `CI0QLyowHEkOiosO2` | `138.197.148.152` | `53084` | `2222` | `2024-01-09 18:23:35.666673` | `2024-01-09 18:23:35.666673` | `0.0` |
| `CD6gnyuC4oZ33fcLf` | `138.197.148.152` | `57860` | `2222` | `2024-01-09 18:23:38.615564` | `2024-01-09 18:23:38.615564` | `0.0` |
| `C1Q7rU2pRhthY9GC4` | `138.197.148.152` | `59696` | `2222` | `2024-01-09 18:23:39.754764` | `2024-01-09 18:23:39.754764` | `0.0` |
| `CKP7wZ33wwAuF9kExh` | `138.197.148.152` | `60376` | `2222` | `2024-01-09 18:23:40.171042` | `2024-01-09 18:23:40.171042` | `0.0` |
| `CPuLkv1OEHjkyuMpt8` | `138.197.148.152` | `35818` | `2222` | `2024-01-09 18:23:42.500379` | `2024-01-09 18:23:42.500379` | `0.0` |
| `CkMYMq2F8YYI1Piwv7` | `138.197.148.152` | `36272` | `2222` | `2024-01-09 18:23:42.790800` | `2024-01-09 18:23:42.790800` | `0.0` |
| `CkMSpGme7NAqbEzM5` | `138.197.148.152` | `36942` | `2222` | `2024-01-09 18:23:43.215536` | `2024-01-09 18:23:43.215536` | `0.0` |
| `CZH616lYWKuze1J91` | `138.197.148.152` | `40656` | `2222` | `2024-01-09 18:23:45.570222` | `2024-01-09 18:23:45.570222` | `0.0` |
...
```shell
The `malware_source_code` key has an empty value, therefore no source code is available to comment.
```
...
Since the malware source code has not been provided, we can infer the behavior and purpose of the malware from the sequence of commands executed by the attacker on the honeypot system. The commands indicate a comprehensive attack pattern that involves downloading and executing scripts, an attempt at persistence, and possible destructive actions. Here is the step-by-step activity carried out by the attacker:

1. The attacker attempts to change the working directory to `/tmp`, `/var/run`, `/mnt`, `/root`, or the root directory `/`, indicating the desire to work in a directory with write permissions and likely to persist across reboots (`/tmp` is typically not persistent across reboots).
2. Using `wget`, the attacker downloads a script named `fuckjewishpeople.sh` from a remote server (`213.255.246.81`). The naming of the script is clearly offensive and inappropriate.
3. The attacker changes the permissions of the downloaded script to `777`, making it readable, writable, and executable by all users.
4. The script is then executed using `sh`, suggesting that it's a shell script.
5. The pattern of download, permission change, and execution is repeated with TFTP commands for `tftp1.sh` and `tftp2.sh`, which indicates that the attacker is using different protocols and scripts, likely for redundancy or different payloads.
6. A command is issued to remove all files in the current directory (`rm -rf *`). This is a highly destructive action and is likely meant to either cover tracks or harm the system.
7. The set of commands is repeated multiple times, which shows either a script is in a loop or the attacker is persistently trying to ensure that the malware is downloaded and executed.

Given these steps, it appears the attacker's goal is to gain control over the honeypot system, execute potentially malicious scripts, and possibly cause destruction or disruption. All the commands reflect standard Unix/Linux shell commands.

**Note on Security**: The repetition and particularly the content of the script's name imply a less sophisticated attacker, potentially engaging in offensive or hate-driven cyber vandalism rather than a targeted and strategic cyber attack carried out by professionals.
