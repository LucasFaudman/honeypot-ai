...
- A total of `3885` log events were logged in `5` log files: `cowrie.2024-01-10.json`, `cowrie.2024-01-10.log`, `notice.log`, `conn.log`, `ssh.log`
...
- A total of `3885` log events were logged in `5` log files: 
...
#### The `253` Zeek sessions in this attack were logged in the following Zeek logs:
