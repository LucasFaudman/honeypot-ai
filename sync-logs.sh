...
ZEEK_REMOTE_PATH="/srv/zeek/logs/aggregate"
WEBLOGS_REMOTE_PATH="/srv/db"
COWRIE_REMOTE_PATH="/srv/cowrie/var/log/cowrie"
FIREWALL_REMOTE_PATH="/var/log"
MALWARE_REMOTE_PATH="/srv/cowrie/var/lib/cowrie/downloads"
