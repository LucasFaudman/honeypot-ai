...
selected_version = options_menu(
    version_options, version_q, 'version number', -1).split(' ')[1]
...
destfolder = input(f"Where do you want to save {filename}? (default: {RESOURCES_PATH}): ").rstrip(
    '/') or RESOURCES_PATH
