...
- A total of `260` log events were logged in `8` log files: `cowrie.2023-11-30.json`, `cowrie.2023-11-30.json`, `auth_random.json`, `auth_random.json`, `cowrie.2023-11-30.log`, `cowrie.2023-11-30.log`, `dshield.log`, `dshield.log`
...
- This attack was carried out by a `1` unique **source IP** address(es):
	- `SourceIP 204.76.203.13 with 5 sessions, 1 dst_ports 1 successful logins, 9 commands, 0 uploads, 4 downloads`
...
- A total of `260` log events were logged in `6` log files: 
